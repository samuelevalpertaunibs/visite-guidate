...
public class TipoVisita extends TipoVisitaCore {
    ...
    private final HashMap<Integer, String> volontari;


    public TipoVisita(Integer id, String titolo, String descrizione, LocalDate dataInizio, LocalDate dataFine, LocalTime oraInizio, int durataMinuti, boolean entrataLibera, int numMinPartecipanti, int numMaxPartecipanti, PuntoIncontro puntoIncontro, Luogo luogo, Set<Giorno> giorni, HashMap<Integer, String> volontari) {
    ...
    public TipoVisita(TipoVisitaCore tvc, Luogo luogo, Set<Giorno> giorni, HashMap<Integer, String> volontari) {
    ...
    public HashMap<Integer, String> getVolontari() {
        return volontari;
    }
